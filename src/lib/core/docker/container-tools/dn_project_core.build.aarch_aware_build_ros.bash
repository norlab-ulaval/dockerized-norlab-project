...
#   ARG TARGETPLATFORM
#   ARG BUILDPLATFORM
#   WORKDIR /path/to/ros/package
#   RUN <<EOF
#     source /dna-lib-container-tools/dn_project_core.build.aarch_aware_build_ros.bash \
#               ${TARGETPLATFORM} ${BUILDPLATFORM} \
#               "install/from/path" [ANY_COLCON_BUILD_FLAG]
#   EOF
#
# Positional argument:
#   TARGETPLATFORM            The target platform env var (generated by docker buildx)
#   BUILDPLATFORM             The host platform env var (generated by docker buildx)
#   "install/from/path"       The path passed to `rosdep install --from-path`
#   ANY_COLCON_BUILD_FLAG     Any legal colcon build flags (optional)
#
# Globals:
#   Read ROS_DISTRO
...
function dna::build_ros() {
  ...
  colcon_flags+=( "${ANY_COLCON_BUILD_FLAG[@]}" )
