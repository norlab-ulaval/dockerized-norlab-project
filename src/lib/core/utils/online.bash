...
#
# Usage:
#     $ dnp::is_online [reliable_dns_address]
#
# Arguments:
...
#
# Usage:
#     $ dnp::check_git_branch_exists_on_remote <remote-url> <branch-name>
#
# Arguments:
...
#
# Example in code:
#   if dnp::check_git_branch_exists_on_remote "https://github.com/norlab-ulaval/dockerized-norlab" "dev" >/dev/null ; then
#      :  # do something
#   fi
#
# =================================================================================================
function dnp::check_git_branch_exists_on_remote() {
