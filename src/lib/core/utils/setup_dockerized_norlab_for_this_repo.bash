#!/bin/bash
# =================================================================================================
# Setup workstation for using Dockerized-NorLab with this repository
#
# Usage:
#   $ source setup_dockerized_norlab_for_this_repo.bash
#
# =================================================================================================
...
function dnp::setup_dockerized_norlab_for_this_repo() {
  ...
  DN_PROJECT_ALIAS_PREFIX="dn${DN_PROJECT_ALIAS_PREFIX:?err}"
  ...
  (
    echo ""
    echo "# ${PROJECT_GIT_NAME:?err} aliases and env variable"
    ...
    echo "alias ${DN_PROJECT_ALIAS_PREFIX}_cdd='cd ${SUPER_PROJECT_ROOT}/.dockerized_norlab_project/execute'"
...
if [[ "${BASH_SOURCE[0]}" = "$0" ]]; then
  ...
  dnp::setup_dockerized_norlab_for_this_repo
fi
