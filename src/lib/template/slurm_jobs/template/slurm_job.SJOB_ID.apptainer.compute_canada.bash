...
#                  artifact/apptainer/, slurm_jobs/slurm_job.<SJOB_ID>.apptainer.compute_canada.bash,
#                  .dockerized_norlab/,
...
#     5. Submit:    from super-project root dir execute $ sbatch slurm_jobs/slurm_job.<SJOB_ID>.apptainer.compute_canada.bash
#
# Usage:
#   $ sbatch slurm_job.<SJOB_ID>.apptainer.compute_canada.bash
#
# =================================================================================================
declare -x SJOB_ID
